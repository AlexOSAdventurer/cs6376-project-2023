...
from ring_delay_baseline import generateConfig
import traceback


def visualizer_baseline(args):
    ...
    if args.render_mode == 'sumo_gui':
        ...
        if args.save_render:
            ...
            env.path = "/home/alex/flow_video_baseline"
...
if __name__ == '__main__':
    ...
    result = joblib.Parallel(n_jobs=10, backend="multiprocessing")(delayed(visualizer_baseline)(args) for _ in range(args.num_rollouts))
